...
@Component({
    selector: 'hrmreport-viewer',
    templateUrl: './hrmreport-viewer.component.html',
    styleUrls: ['./hrmreport-viewer.component.css'],
    providers: [{ provide: NgbDateParserFormatter, useClass: NgbDateFRParserFormatter }]
})
export class HRMReportViewerComponent implements OnInit, OnChanges {
    ...
    changeReport(obj: any, sender: any) {
        ...
        if (obj != null) {
            ...
            if (this.selectedReport.reportFormat == "2") {
                ...
                this.rMaster.ReportName = "Reports\\HRMReports\\" + this.selectedReport.reportName;
    ...
    reportParams(rid: number) {
        ...
        switch (rid) {
            ...
            case 920042:
                ...
                this.params.push(new ReportParam("@CNIC", (this.cnic != null ? this.cnic : "-1")));
                this.params.push(new ReportParam("@JobStatusID", (this.status != null ? this.status : "-1")));
            ...
            case 920013:
                ...
                this.params.push(new ReportParam("@EmploymentTypeID", (this.EmploymentTypeId != null ? this.EmploymentTypeId[0].id : "-1")));
                this.params.push(new ReportParam("@CNIC", (this.cnic != null ? this.cnic : "-1")));
                this.params.push(new ReportParam("@Status", (this.status != null ? this.status : "-1")));
            ...
            case 920004:
                ...
                this.params.push(new ReportParam("@EmploymentTypeID", (this.EmploymentTypeId != null ? this.EmploymentTypeId[0].id : "-1")));
                this.params.push(new ReportParam("@CNIC", (this.cnic != null ? this.cnic : "-1")));
                this.params.push(new ReportParam("@Confirm", (this.confirm != null ? this.confirm : "-1")));
