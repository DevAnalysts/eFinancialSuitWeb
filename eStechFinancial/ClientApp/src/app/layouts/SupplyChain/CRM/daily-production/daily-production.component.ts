...
public valid:Validation=new Validation();
  ...
  ngOnInit() {
    this.PermissionUtility.setPagePermissions(140054);
   ...
   if(this.isCloseCheckbox==true)
   {
     ...
     this.status1 =0;
      ...
      var order = new dailyProduction(this.production_ID, this.prod_Date.getDateFinal(), this.production_No, this.contractNo, this.shift_Id, this.hall_No,
        this.shiftIncharge, this.fourman, this.deparment_From, this.department_To, this.remarks,this.created_By,this.userSessionID, this.dailyProductionDetails, this.status1);
