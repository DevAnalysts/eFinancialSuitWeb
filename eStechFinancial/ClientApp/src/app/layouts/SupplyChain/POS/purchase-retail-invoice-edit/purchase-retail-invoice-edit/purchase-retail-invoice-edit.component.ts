...
import { PurchaseOrderInvoiceService, LoginService, SupplierService, Suppliers, FileAttachmentService, SearchFilterService, Supplier, purchaseOrder, purchaseOrderDetails, cDate, NgbDateFRParserFormatter, EmailAlertService, itemStockIMEI, PermissionUtility } from '../../../../../shared';
import swal from 'sweetalert';

@Component({
  selector: 'purchase-retail-invoice-edit',
  host: { '(window:keydown)': 'hotkeys($event)' },
  templateUrl: './purchase-retail-invoice-edit.component.html',
  styleUrls: ['./purchase-retail-invoice-edit.component.scss'],
  providers: [{ provide: NgbDateParserFormatter, useClass: NgbDateFRParserFormatter }]
})
export class PurchaseRetialInvoiceEditComponent implements OnInit, AfterViewChecked {
  ////////////////////////////////////////
  ...
  ngOnInit() {
    ...
    this.orderID = sessionStorage.getItem('purchase_Order_ID');
  ...
  IfSold(purchase_Order_ID)
  {
    this.isLoading = true;
    this.service.IfSold(purchase_Order_ID)
    .subscribe(response => {
  ...
  addGrid(item_Code: any, item_Name: any, Unit_Price: any, Quantity: any, Discount_Rate: any, Tax_Rate: any, imei: any) 
  {
      var arrary =[];
    if(this.detail!=null)
      arrary = this.detail.filter(o => o.imei == imei);
  ...
  getDetailsByID(purchase_Order_ID) {
    ...
    this.service.getDetailsByID(purchase_Order_ID, this.userCurrentOffice, this.userCurrentWarehouse)
      .subscribe((o: purchaseOrder) => {
        ...
        this.service.getAllIMEI(this.purchase_Order_ID, true,80012)
          .subscribe(response => {
  ...
  //updateOrder
  updateOrder1(purchase_Order_ID: any, PO_Date: any, Office_Code: any, PO_NO: any,
    order_Envoy: any, Approved_By_ID: any, isApproved: any, supplier_ID: any,
    contact_Person_ID: any, delivery_Date: any, Shipping_Date: any,
    method_Id: any, payment_ID: any, frieght_Id: any, Total_Cost: any,
    Total_Discount: any, Pre_Tax_Amount: any, Total_Tax: any, freight_Chrgs: any,
  ...
  updateOrder(purchase_Order_ID: any, PO_Date: any, Office_Code: any, PO_NO: any,
    ...
    C_Contact_Person_ID: any, Requisition_ID: any, Day_Id: any, IsServiceInvoice: any) {
      if(this.status == true)
      {
        swal("Item is Sold","You can not edit this order because some items are sold","error");
        return;
      }
    this.isLoading = true;
    this.allowOfficeWarehouse();
