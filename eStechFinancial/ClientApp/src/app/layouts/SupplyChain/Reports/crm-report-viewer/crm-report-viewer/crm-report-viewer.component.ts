...
@Component({
  selector: 'crm-report-viewer',
  templateUrl: './crm-report-viewer.component.html',
  styleUrls: ['./crm-report-viewer.component.scss'],
  providers: [{ provide: NgbDateParserFormatter, useClass: NgbDateFRParserFormatter }]
})
export class CRMReportViewerComponent implements OnInit, OnChanges {
  ...
  vehicle_ID: any = 0;
  vehicle_NO : any = '';
  constructor(private dataserv: DataService, private rv: SCMReportViewerService, private service: ReportService, private lservice: LoginService, private hservice: HeaderService, public router: Router, private searchfilter: SearchFilterService, private LoginService: LoginService) {
  ...
  ngOnInit() {
    ...
    this.hservice.getUserPriviligedFiles(this.logedInUserID)
      .subscribe(response => {
        ...
        this.reports = this.allreports.filter(f => f.sub_Header_ID == sessionStorage.getItem('subHeader') && f.showinMenue == 1);//
  ...
  setCriteriaView(rid: number) {
    ...
    switch (rid) {
      ...
      case 809075:
        this.criteriaSets("CSICustomerAging");
        break;
      ...
      case 809122:
        ...
        /*
                ...
                if(rid ==809001)
                {
                  ...
                  this.detailPageId=rid;
                 // this.summaryPageId=809018;
                  this.showSUbReport(this.detailPageId);
                }*/
        break;
      case 809118:
        this.criteriaSets("CSSIRouteDay");
        this.orderShow = true;
        break;
      case 809062:
      case 809063:
    ...
    console.clear();
    console.log(this.selectedReport.page_Code + '====' + rid);
    switch (rid) {
      case 809000:
      case 809037:
      case 809001:
  ...
  case 809095:
        ...
        this.params.push(new ReportParam("@SupplierID", "-1"));
        this.params.push(new ReportParam("@CustomerID", (this.CustomerId != null ? this.CustomerId[0].id : "-1")));
        this.params.push(new ReportParam("@Office_Code", (this.OfficeId != null ? this.OfficeId[0].id : this.userPrivilegedOffice)));
        this.params.push(new ReportParam("@CategoryCode", (this.PersonCategoryId != null ? this.PersonCategoryId[0].id : "-1")));
        this.dspparams = "Office :" + (this.OfficeId != null ? this.OfficeId[0].itemName : "All");
      ...
      case 809004:
        ...
        this.dspparams = "Office :" + (this.OfficeId != null ? this.OfficeId[0].itemName : "All") + "          "
          ...
          + (this.ProvinceId != null ? "Provice : " + this.ProvinceId[0].itemName + "          " : "")
          + (this.AreaId != null ? "Area : " + this.areaNames + "          " : "")
          + (this.vehicle_ID != null ? "Vehicle : " + this.vehicle_NO + "          " : "")
          + (this.UserId != null ? "Officer : " + this.UserId[0].itemName + "          " : "");
        break;
      ...
      case 809122:
        ...
        break;
      case 809118:
        this.params.push(new ReportParam("@Datefrom", (this.DateTo.getDateFinal() != null ? this.DateTo.getDateFinal() : this.date)));
        this.params.push(new ReportParam("@Office_Code", (this.OfficeId != null ? this.OfficeId[0].id : this.userPrivilegedOffice)));
        this.params.push(new ReportParam("@CustomerID", (this.CustomerId != null ? this.CustomerId[0].id : "-1")));
        this.params.push(new ReportParam("@AREA_CODE", (this.AreaId != null ? this.areaIds : "-1")));
        this.params.push(new ReportParam("@UserID ", (this.UserId != null ? this.UserId[0].id : "-1")));
        this.params.push(new ReportParam("@Order", this.order));
  ...
  criteriaSets(cset: any) {
    ...
    else if (cset == "CSICustomerAging") {
      this.customerCategoryShow = true;
      this.dateFromShow = false;
      this.customerShow = true;
    }
    else if (cset == "CSSIRouteDay") {
      this.customerCategoryShow = true;
      this.customerShow = true;
      this.areaShow = true;
      this.officerShow = true;
