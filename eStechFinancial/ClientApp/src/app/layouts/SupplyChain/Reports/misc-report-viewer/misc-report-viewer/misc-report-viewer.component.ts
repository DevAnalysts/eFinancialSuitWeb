...
@Component({
  selector: 'misc-report-viewer',
  templateUrl: './misc-report-viewer.component.html',
  styleUrls: ['./misc-report-viewer.component.scss'],
  providers: [{ provide: NgbDateParserFormatter, useClass: NgbDateFRParserFormatter }]
})
export class MiscReportViewerComponent implements OnInit, OnChanges {
  currentValue: any = 0;
  ...
  changeWarehouse(e) {
    for (let i = 0; i < this.warehouses.length; i++)
      if (this.warehouses[i].id == e.value) {
