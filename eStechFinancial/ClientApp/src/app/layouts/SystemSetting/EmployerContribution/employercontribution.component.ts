...
import { EmployerContributionService, EmployerContribution, PermissionUtility } from '../../../shared';
import swal from 'sweetalert';
import { Validation } from '@shared/common/validation';

@Component({
  selector: 'employercontribution',
  templateUrl: './employercontribution.component.html',
    styleUrls: ['./employercontribution.component.scss']
    ,
    host: {
        '(window:resize)': 'onResize($event)'
    }
})
export class EmployerContributionComponent implements OnInit {
 ...
 isLoading: any = false;
  ...
  constructor(private service: EmployerContributionService) { }

  ngOnInit() {
      this.getGrid();
      this.logedInUserID = this.service.getSession('user_ID');
      this.permissionUtility.setPagePermissions(110039); 
    }
     ////////////////////////
  ...
  saveData() {
    if (this.CheckBoxAllowance)
      var Data = new EmployerContribution(0, this.packageallowancename, 0, this.percent, 'A', this.allowancecode, 0, this.active, this.accountcode, this.categorycode);
       else
      var Data = new EmployerContribution(0, this.packageallowancename, this.fixedamount, 0, 'F', '', 0, this.active, this.accountcode, this.categorycode);
    ...
    if (packageallowancename != "") {
      ...
      this.packageallowancename='';
      swal("Allowance Name of Employee Contribution Must Be Defined.");
    }
  ...
  updateData() {
    if (this.CheckBoxAllowance) 
      var Data = new EmployerContribution(this.packageallowancecode, this.packageallowancename, 0, this.percent, 'A', this.allowancecode, 0, this.active, this.accountcode, this.categorycode);
      else
      var Data = new EmployerContribution(this.packageallowancecode, this.packageallowancename, this.fixedamount, 0, 'F', '', 0, this.active, this.accountcode, this.categorycode);
