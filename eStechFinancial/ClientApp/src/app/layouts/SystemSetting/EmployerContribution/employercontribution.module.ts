...
import { EmployerContributionRoutingModule } from './employercontribution-routing.module';
...
@NgModule({
  imports: [
    ...
    SharedPipesModule,
    NgbModule,
    EmployerContributionRoutingModule,
    NgxPaginationModule,
    Ng2SearchPipeModule
  ],
  declarations: [EmployerContributionComponent]
})
export class EmployerContributionModule { }
