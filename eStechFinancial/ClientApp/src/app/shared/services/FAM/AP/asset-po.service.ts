...
import { AssetPO } from '../../../../shared';


@Injectable()
export class AssetPOService {

  orderurl = 'api/AssetPO';
  ...
  getPriviledgedOffices() {
    return this.httpRepository.getData(this.orderurl + "/getPriviledgedOffices")
  }
  //getSuppliers
  getSuppliers() {
  ...
  //getDetailsByID
  getDetailsByID(ID: Number): Observable<AssetPO> {
