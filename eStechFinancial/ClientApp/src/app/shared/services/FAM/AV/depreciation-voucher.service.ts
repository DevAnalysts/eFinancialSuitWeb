...
import { DepreciationVoucher } from '../../../../shared';

@Injectable()
export class DepreciationVoucherService {

  URL = 'api/DepreciationVoucher';
  ...
  //saveData
  saveData(abc: Array<DepreciationVoucher>): Promise<any> {
    let body = JSON.stringify(abc);
    //alert(body);
     return this.httpRepository.create(this.URL, abc )
      .toPromise()
      .then(res => res.json() as DepreciationVoucher)
      .catch()
  }
  //updateData
