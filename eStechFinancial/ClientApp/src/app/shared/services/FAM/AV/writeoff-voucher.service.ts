...
import { WriteoffVoucher } from '../../../../shared';

@Injectable()
export class WriteoffVoucherService {

  URL = 'api/WriteoffVoucher';
  ...
  //saveData
  saveData(abc: Array<WriteoffVoucher>): Promise<any> {
    let body = JSON.stringify(abc);
    //alert(body);
     return this.httpRepository.create(this.URL, abc )
      .toPromise()
      .then(res => res.json() as WriteoffVoucher)
      .catch()
  }
  //updateData
