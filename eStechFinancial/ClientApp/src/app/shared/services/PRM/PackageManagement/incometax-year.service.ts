...
@Injectable()
export class IncomeTaxYearService {

  URL = 'api/IncomeTaxYear';
  ...
  //getDetailsByID
  getDetailsByID(TaxYear: any) {
    return this.httpRepository.getData(this.URL + "/getDetailsByID?TaxYear=" + TaxYear)
  }
  //searchEmpDetails
