...
export class DailyProductionService {
  ...
  GetDailyProductionDetails(production_ID: any, userPrivilegedOffice: any) {
    return this.httpRepository.getData(this.URL + "/GetDailyProductionDetails?production_ID=" + production_ID + "&userPrivilegedOffice=" + userPrivilegedOffice + "")
  }
  ...
  //getDetailsByID
  getDetailsByID(production_ID: Number): Observable<dailyProduction> {
  ...
  saveOrder(order: any): Promise<any> {
    ...
    return this.httpRepository.create(this.URL + "/save", order)
      .toPromise()
      .then(res => res.json() as dailyProduction)
      .catch()
  }
