...
import { saleOrderContractMain } from '../../../../models/SupplyChain/CRM/saleOrderContractMain';

@Injectable()
export class SaleOrderContractService {

  URL = 'api/SaleOrderContract';
  ...
  getItems(userCurrentOffice : any, userCurrentWarehouse: any) {
    return this.httpRepository.getData(this.URL + "/getItems?=" + userCurrentOffice + "&userCurrentWarehouse=" + userCurrentWarehouse + "")
  }
  //getUnitPrice
  ...
  //getDetailsByID
  getDetailsByID(sale_Order_ID: Number): Observable<saleOrderContractMain> {
