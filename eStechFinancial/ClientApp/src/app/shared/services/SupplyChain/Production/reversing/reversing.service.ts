...
export class ReversingService {
  ...
  GetReversingDetails(production_ID: any, userPrivilegedOffice: any) {
    return this.httpRepository.getData(this.URL + "/GetReversingDetails?production_ID=" + production_ID + "&userPrivilegedOffice=" + userPrivilegedOffice + "")
  }
  ...
  getAllStitchingNo()
  {
    return this.httpRepository.getData(this.URL + "/getAllStitchingNo")
  }
  //getItems
  getItems(stitchingID) {
    return this.httpRepository.getData(this.URL + "/getItems?stitchingID=" + stitchingID + "")
  }
  //getUnitPrice
  ...
  //getDetailsByID
  getDetailsByID(production_ID: Number): Observable<Reversing> {
  ...
  //getDetailsByID
  getStitchingDetailByID(stitchingID: Number): Observable<Reversing> {
    return this.httpRepository.getData(this.URL + "/getStitchingDetailByID?stitchingID=" + stitchingID + "")
      .map((res) => {
        return res.json()[0];
      })
      .catch(this.handleError);
  ...
  saveOrder(order: any): Promise<any> {
    ...
    return this.httpRepository.create(this.URL + "/save", order)
      .toPromise()
      .then(res => res.json() as Reversing)
      .catch()
  }
