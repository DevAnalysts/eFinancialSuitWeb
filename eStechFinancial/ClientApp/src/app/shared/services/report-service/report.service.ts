...
export class ReportService {
  ...
  getSupplierCategory() {
    return this.httpRepository.getData(this.url + '/suppliercategory');
  } 
  getSubject() {
  ...
  getVehicle() {
    return this.httpRepository.getData(this.url + '/getvehicle');
  }
  getItemSubCategory() {
  ...
  getAssetSubCategory(catid: any) {
    return this.httpRepository.getData(this.url + '/getAssetSubCategory?catid=' + catid + '');
  }
  getAssetStatus() {
    return this.httpRepository.getData(this.url + '/getAssetStatus');
  }
  getAssetItemsList() {
    return this.httpRepository.getData(this.url + '/getAssetItemsList');
  }
}
